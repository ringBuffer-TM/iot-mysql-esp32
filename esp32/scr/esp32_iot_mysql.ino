...
const char* password = "Pass du réseau";
//======================================== 
...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    http.begin("http://meelyl2telecome.42web.io/getData.php");  //--> Specify request destination
    ...
    http.begin("http://meelyl2telecome.42web.io/updateDHT11data_and_recordtable.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
